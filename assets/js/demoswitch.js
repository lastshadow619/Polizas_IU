...
jQuery(document).ready(function($) {
	...
	var skinLogoDefault = 'assets/images/kingadmin-logo-white.png';
	...
	$('.switch-skin, .switch-skin-full').click( function(e) {
		...
		if($(this).hasClass('fullbright')) {
			skinLogo = 'assets/images/kingadmin-logo.png';
		}else {
		...
		if( ($(this).attr('data-skin') == 'assets/css/skins/transparent.css') && $('.invoice-header img').length > 0 ) {
			$('.invoice-header img').attr('src', 'assets/images/kingadmin-logo-white.png');
		}
	});
	...
	function resetStyle() {
		...
		$('.logo img').attr('src', 'assets/images/kingadmin-logo-white.png');
